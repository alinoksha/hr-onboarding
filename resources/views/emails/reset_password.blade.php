                                        ...
                                        <table border="0" cellpadding="0" cellspacing="0"
                                            ...
                                            <tr>
                                                <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                                                    <a href="{{config('frontend.paths.set_new_password')}}/{{$hash}}"
                    ...
                    <tr>
                        <td style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box;">
                            <p style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #74787E; line-height: 1.5em; margin-top: 0; text-align: left; font-size: 12px;">
                                ...
                                <a href="{{config('frontend.paths.set_new_password')}}/{{$hash}}" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;"></a>
                                <a href="{{config('frontend.paths.set_new_password')}}/{{$hash}}" style="font-family: Avenir, Helvetica, sans-serif; box-sizing: border-box; color: #3869D4;">
                                    {{config('frontend.paths.set_new_password')}}/{{$hash}}
                                </a>
                            </p>
                        </td>
                    </tr>
