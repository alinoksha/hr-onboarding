...
return [
    ...
    */
    'driver' => env('SWAGGER_DRIVER', 'remote'),
    ...
    'drivers' => [
        ...
        'remote' => [
            ...
            'key' => env('SWAGGER_REMOTE_DRIVER_KEY', 'hr-onboarding'),
            'url' => env('SWAGGER_REMOTE_DRIVER_URL', 'https://docs.ronasit.com')
        ],
        'storage' => [
            ...
            */
            'disk' => env('SWAGGER_STORAGE_DRIVER_DISK', 'gcs'),
