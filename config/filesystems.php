...
return [
    ...
    */
    ...
    'disks' => [
        ...
        'gcs' => [
            'driver' => 'gcs',
            'key_file_path' => env('GOOGLE_CLOUD_STORAGE_KEY_FILE_PATH'), // optional: /path/to/service-account.json
            'project_id' => env('GOOGLE_CLOUD_PROJECT_ID'), // optional: is included in key file
            'bucket' => env('GOOGLE_CLOUD_STORAGE_BUCKET'),
            'path_prefix' => env('GOOGLE_CLOUD_STORAGE_PATH_PREFIX', env('APP_NAME')),
